...
from utils.my_visualization_5 import visualize_multicam_detections
...
def run(params, config, capture, detector, reid, sk_model, class_model, detector_pipeline, clo_model, palette, cfg):
    ...
    while thread_body.process:
        ...
        vis, id_list, pose_list, gif_cnt, img_cnt, next_frame_id_to_show, next_frame_id, id_dress_list, id_dress_list_cnt, id_object_list, self_cnt = visualize_multicam_detections(prev_frames, tracked_objects, id_list, pose_list, sk_model, class_model, clo_model, detector_pipeline, cfg, img_cnt, gif_cnt, next_frame_id_to_show, next_frame_id, id_dress_list, id_dress_list_cnt, id_object_list, self_cnt, fps='', **config['visualization_config'])
